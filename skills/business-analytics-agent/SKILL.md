...
1. **Trend extrapolation**: Apply 3-month moving average to current trajectory
2. **Seasonality adjustment**: Apply UAE seasonal multipliers (Ramadan -20% B2B, Q4 +25%)
3. **Confidence intervals**: Always report P50 (base case) and P90 (optimistic) scenarios
4. **Risk factors**: Identify top 3 assumptions that could invalidate the forecast
...
1. Data period is clearly stated (e.g., "Q1 2025: Jan 1 – Mar 31")
2. Currency and units are consistent throughout
3. All percentages state what they're a percentage of
4. Forecasts clearly label base case vs. optimistic vs. pessimistic
